...
import net.bluelotuscoding.puffishskillleveling.client.event.ClientEventListener;
import net.bluelotuscoding.puffishskillleveling.client.event.ClientEventReceiver;
import net.bluelotuscoding.puffishskillleveling.client.gui.SimpleToast;
import net.bluelotuscoding.puffishskillleveling.client.gui.SkillsScreen;
import net.bluelotuscoding.puffishskillleveling.client.keybinding.KeyBindingReceiver;
import net.bluelotuscoding.puffishskillleveling.client.network.ClientPacketSender;
import net.bluelotuscoding.puffishskillleveling.client.network.packets.in.ExperienceUpdateInPacket;
import net.bluelotuscoding.puffishskillleveling.client.network.packets.in.HideCategoryInPacket;
import net.bluelotuscoding.puffishskillleveling.client.network.packets.in.NewPointInPacket;
import net.bluelotuscoding.puffishskillleveling.client.network.packets.in.OpenScreenInPacket;
import net.bluelotuscoding.puffishskillleveling.client.network.packets.in.PointsUpdateInPacket;
import net.bluelotuscoding.puffishskillleveling.client.network.packets.in.ShowCategoryInPacket;
import net.bluelotuscoding.puffishskillleveling.client.network.packets.in.ShowToastInPacket;
import net.bluelotuscoding.puffishskillleveling.client.network.packets.in.SkillUpdateInPacket;
