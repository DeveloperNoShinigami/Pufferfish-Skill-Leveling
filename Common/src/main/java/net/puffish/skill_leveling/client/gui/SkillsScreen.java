package net.puffish.skill_leveling.client.gui;
...
import net.puffish.skill_leveling.client.config.ClientBackgroundConfig;
import net.puffish.skill_leveling.client.config.ClientFrameConfig;
import net.puffish.skill_leveling.client.config.ClientIconConfig;
import net.puffish.skill_leveling.client.config.skill.ClientSkillConfig;
import net.puffish.skill_leveling.client.config.skill.ClientSkillDefinitionConfig;
import net.puffish.skill_leveling.client.data.ClientCategoryData;
import net.puffish.skill_leveling.client.data.ClientSkillScreenData;
import net.puffish.skill_leveling.client.network.packets.out.SkillClickOutPacket;
import net.puffish.skill_leveling.client.rendering.ConnectionBatchedRenderer;
import net.puffish.skill_leveling.client.rendering.ItemBatchedRenderer;
import net.puffish.skill_leveling.client.rendering.TextureBatchedRenderer;
import net.puffish.skill_leveling.common.BackgroundPosition;
import net.puffish.skill_leveling.util.Bounds2i;
