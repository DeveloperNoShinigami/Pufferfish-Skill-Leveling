...
import net.bluelotuscoding.puffishskillleveling.common.SkillConnection;
import net.bluelotuscoding.puffishskillleveling.config.BackgroundConfig;
import net.bluelotuscoding.puffishskillleveling.config.CategoryConfig;
import net.bluelotuscoding.puffishskillleveling.config.FrameConfig;
import net.bluelotuscoding.puffishskillleveling.config.GeneralConfig;
import net.bluelotuscoding.puffishskillleveling.config.IconConfig;
import net.bluelotuscoding.puffishskillleveling.config.colors.ColorConfig;
import net.bluelotuscoding.puffishskillleveling.config.colors.ColorsConfig;
import net.bluelotuscoding.puffishskillleveling.config.colors.ConnectionsColorsConfig;
import net.bluelotuscoding.puffishskillleveling.config.colors.FillStrokeColorsConfig;
