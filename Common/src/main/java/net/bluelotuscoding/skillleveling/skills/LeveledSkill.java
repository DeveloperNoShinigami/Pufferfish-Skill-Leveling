...
public class LeveledSkill {
    ...
    public int getCurrentLevel(ServerPlayerEntity player) {
        ...
        return SkillLevelingMod.getInstance().getTotalSkillLevel(player, categoryId, skillId);
    }
    ...
    public String getDescription() {
        return "Leveled skill: " + baseSkill.getId(); // Create description since Skills API doesn't provide
                                                      // getDescription()
    }
}