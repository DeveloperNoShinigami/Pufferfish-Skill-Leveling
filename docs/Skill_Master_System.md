...
|-------|---------|-------------|
| `base_experience_per_trade` | 5 | Base villager XP earned per dynamic skill tome trade |
| `bonus_for_both_mode_skills` | 3 | Extra XP for trading skills with `loot_mode: "both"` |
| `bonus_for_imbue_only_skills` | 5 | Extra XP for trading skills with `loot_mode: "imbue_only"` |
| `experience_multiplier_per_villager_tier` | 2 | XP multiplier added per tier (Tier 3 = base + 6) |
| `experience_bonus_per_mastered_skill` | 2 | XP bonus per skill the player has mastered |
| `maximum_mastery_experience_bonus` | 20 | Cap on mastery XP bonus |
...
| Field | Default | Description |
|-------|---------|-------------|
| `sigil_proxy_trade` | 5 | XP for the Level 1 proxy trade (Blank Tome) |
| `tome_of_clear_mind` | 10 | XP for selling Tome of Clear Mind |
| `tome_of_cleansing` | 15 | XP for selling Tome of Cleansing I |
| `sigil_of_imbuement` | 50 | XP for selling Sigil of Imbuement |
| `tome_of_cleansing_upgrade` | 25 | XP for selling Tome of Cleansing II/III |

#### Dynamic Trade Settings

| Field | Default | Description |
|-------|---------|-------------|
| `special_upgrade_trade_base_chance` | 0.1 | Base probability of offering an upgrade trade (10%) |
| `special_upgrade_trade_max_chance` | 0.25 | Maximum upgrade trade probability at 10+ masteries (25%) |
| `tome_price_multiplier_at_level_1` | 1.2 | Price multiplier for Level 1 tomes (120% of base) |
| `tome_price_multiplier_at_max_level` | 0.5 | Price multiplier for max-level tomes (50% of base) |
| `tome_upgrade_price_multiplier` | 0.6 | Price discount for upgrade trades (60% of standard price) |
