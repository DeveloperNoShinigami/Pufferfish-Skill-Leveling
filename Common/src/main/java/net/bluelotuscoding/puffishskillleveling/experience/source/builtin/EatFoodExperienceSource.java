...
import net.bluelotuscoding.puffishskillleveling.calculation.operation.LegacyOperationRegistry;
...
import net.bluelotuscoding.puffishskillleveling.calculation.operation.builtin.ItemStackNbtCondition;
